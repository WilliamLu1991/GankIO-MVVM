package com.williamlu.widgetlib.bigimageviewpager.view.helper;
...
@SuppressWarnings("unused") public class SubsamplingScaleImageViewDragClose extends View {
     ...
     * the supplied  and expressed as screen pixels. For example, if the image cannot be
     * panned any further towards the left, the value of  will be set to 0.
     *
