...
public class CustomRatingBar extends LinearLayout implements View.OnClickListener,
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            starDrawable = array.getDrawable(R.styleable.CustomRatingBar_star_img);
            unStarDrawable = array.getDrawable(R.styleable.CustomRatingBar_unstar_img);
            width = array.getDimension(R.styleable.CustomRatingBar_image_width, dip2px(context, 36));
            height = array.getDimension(R.styleable.CustomRatingBar_image_height, dip2px(context, 36));
            imagePadding = array.getDimension(R.styleable.CustomRatingBar_image_padding, 5);
            clickable = array.getBoolean(R.styleable.CustomRatingBar_clickable, true);
            starCount = array.getInt(R.styleable.CustomRatingBar_star_count, 5);
            star = array.getInt(R.styleable.CustomRatingBar_star, 0);
            array.recycle();
        }
