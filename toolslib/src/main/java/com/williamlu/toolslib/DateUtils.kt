...
object DateUtils {
    ...
    val DATE_DDHHMMSS = "HH:mm:ss"
    val DATE_YYYYMMDDHHMM = "yyyy-MM-dd HH:mm"
     ...
     */
    fun getTimeToYYYYMMDDHHMM(time: String): String {
        try {
            val sdr = SimpleDateFormat("yyyy-MM-dd HH:mm")
            return sdr.format(Date(time.toLong()))
        } catch (e: Exception) {
        }
        return ""
    }

    fun getTimeBySecondToYYYYMMDD(time: String): String {
        try {
            val sdr = SimpleDateFormat("yyyy.MM.dd")
            return sdr.format(Date(time.toLong() * 1000))
        } catch (e: Exception) {
        }
        return ""
    }

    fun getTimeToYYYYMMDDHHMMSS(time: String): String {
        try {
            val sdr = SimpleDateFormat(DATE_YYYYMMDDHHMMSS)
            return sdr.format(Date(time.toLong()))
        } catch (e: Exception) {
        }
        return ""
    ...
    fun getTimeToHHMMSS(time: String): String {
        try {
            val sdr = SimpleDateFormat(DATE_DDHHMMSS)
            return sdr.format(Date(time.toLong()))
        } catch (e: Exception) {
        }
        return ""
    ...
    fun getTimeToMMDD(time: Long): String {
        try {
    ...
    fun getRemainTimeStr(time: Long, isNum: Boolean = false): String {
        if (time <= 0) {
            if (isNum) {
                return "00:00:00"
            } else {
