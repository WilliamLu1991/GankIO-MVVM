 ...
 * @author vinda
 * @since 15/5/22
 * form https://github.com/didi/DoraemonKit
 */
public class NotificationUtils {
    private static final String ID_HIGH_CHANNEL = "com.williamlu.testmvvm_channel_1";
    private static final String NAME_HIGH_CHANNEL = "消息通知";

    private static final String ID_LOW_CHANNEL = "com.williamlu.testmvvm_channel_2";
    private static final String NAME_LOW_CHANNEL = "商品推荐";
    ...
    public static void setMessageNotification(Context context, int notifyId, int smallIconId, CharSequence title, CharSequence summary, CharSequence ticker, PendingIntent pendingIntent) {
        ...
        builder.setSmallIcon(smallIconId)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.lib_ic_app))
    ...
    public static void setInfoNotification(Context context, int notifyId, CharSequence title, CharSequence summary, CharSequence ticker, PendingIntent pendingIntent) {
        ...
        builder.setSmallIcon(R.drawable.lib_ic_app)
                .setContentTitle(title)
                .setContentText(summary)
                .setAutoCancel(true)
                .setProgress(0, 0, false);// Removes the progress bar
